...
const ServiceContent: React.FC = () => {
  ...
  const loadServices = async (page: number) => {
    ...
    try {
      const response = await getServicesRequest(page);
          ...
          <CardContent className="p-4 flex gap-3">
            ...
            <div className="flex-1">
              ...
              <Button
                ...
                onClick={() => loadServices(currentPage)}
              >
                Tentar novamente
              </Button>
            </div>
                      ...
                      appointments.map((appointment, index) => (
                        ...
                        >
                          ...
                          <TableCell className="text-gray-600 text-sm max-w-sm">
                            <div className="line-clamp-2" title={appointment.description}>
                      ...
                      <TableRow>
                        <TableCell colSpan={7} className="text-center py-12">
                          <div className="flex flex-col items-center gap-2">
                            ...
                            <p className="text-gray-500 text-sm">Comece criando seu primeiro serviço</p>
                          </div>
                        </TableCell>
                      </TableRow>
                    )}
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <div className="text-sm text-gray-600">
                    <p>
                      ...
                      <span className="font-semibold text-gray-900">{paginationData.total}</span> serviços
                    </p>
                  </div>
